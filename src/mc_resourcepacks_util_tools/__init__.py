...
def main() -> None:
    ...
    parser: ArgumentParser = ArgumentParser(
        description="Extracts and compiles a list of installed, enabled and disabled resource packs, inside the closest minecraft folder."
    )
    parser.add_argument(
        "--dir",
    ...
    if args.compile:
        ...
        compile_resourcepacks(
            args, resourcepack_tuple.enabled, resourcepack_tuple.incompatible
        )
    elif args.decompile:
        ...
        decompile_resourcepacks(
            args, resourcepack_tuple.enabled, resourcepack_tuple.disabled
        )
    else:
